...
def mock_weather_for_coordinates(*args, **kwargs):
    ...
    elif args[2] == aiohere.WeatherProductType[MODE_HOURLY]:
        return hourly_response
    elif args[2] == aiohere.WeatherProductType[MODE_DAILY]:
        return daily_response
    elif args[2] == aiohere.WeatherProductType[MODE_DAILY_SIMPLE]:
        return daily_simple_forecasts_response
    elif args[2] == aiohere.WeatherProductType[MODE_OBSERVATION]:
